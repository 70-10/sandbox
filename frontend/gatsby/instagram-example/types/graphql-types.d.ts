...
export type ScrapingQueryVariables = {};


export type ScrapingQuery = { allInstaNode: { edges: Array<{ node: (
        Pick<InstaNode, 'id' | 'username' | 'likes' | 'caption' | 'comments'>
        & { localFile?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }> }
      ) }> } };
